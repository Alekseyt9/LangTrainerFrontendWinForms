...
namespace LangTrainerFrontendWinForms.Controls.Out.Accordion
{
    ...
    public class Accordion : UserControl, IMessageFilter
    {
        ...
        {
            Point pt = AutoScrollPosition; // always maintain the current X value.
            if (isOpening)
            {
        ...
        protected override void OnFontChanged(EventArgs e)
        {
            ...
            Font toolBoxFontNew = new Font(toolBoxFont.FontFamily, Font.Size);
